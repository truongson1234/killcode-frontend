...
import '@/assets/admin/admin.js'
import { configDOM, darkMode, sidebarColor, sidebarType } from "@/assets/admin/js/argon-dashboard.js"
var ctx1 = ref(null), gradientStroke1 = ref(null), inputDarkMode = ref(null)
function darkModeClick() {
    darkMode(inputDarkMode.value)
}
function sidebarColorClick(event) {
    sidebarColor(event.target)
}

function sidebarTypeClick(event) {
    sidebarType(event.target)
}
onMounted(() => {
    configDOM()
                        ...
                        <div class="card z-index-2 h-100">
                            <div class="card-header pb-0 pt-3 bg-transparent">
                                ...
                                <p class="text-sm mb-0">
                                    ...
                                    <span class="font-weight-bold">4% more</span> in
                                    2021
                                </p>
                            </div>
                            <div class="card-body p-3">
                    ...
                    <div class="col-lg-5">
                        <div class="card card-carousel overflow-hidden h-100 p-0">
                            <div id="carouselExampleCaptions"
                                ...
                                <div class="carousel-inner border-radius-lg h-100">
                                    <div class="carousel-item carousel-item-1 h-100 active">
                                        <div
                                            ...
                                            <h5 class="text-white mb-1">Get started
                                                with Argon</h5>
                                            <p>There’s nothing I really wanted to do
                                                in life that I wasn’t able to get
                                                good at.</p>
                                        </div>
                                    </div>
                                    <div class="carousel-item carousel-item-2 h-100">
                                        <div
                                            ...
                                            <h5 class="text-white mb-1">Faster way
                                                to create web pages</h5>
                                            <p>That’s my skill. I’m not really
                                                specifically talented at anything
                                    ...
                                    <div class="carousel-item carousel-item-3 h-100">
                                        <div
                                            ...
                                            <h5 class="text-white mb-1">Share with
                                                us your design tips!</h5>
                                            <p>Don’t be afraid to be wrong because
                                                you can’t learn anything from a
                                                compliment.</p>
                                        </div>
                                    </div>
                                </div>
                                <button class="carousel-control-prev w-5 me-3"
                                    type="button"
                                ...
                                <button class="carousel-control-next w-5 me-3"
                                    type="button"
                                    data-bs-target="#carouselExampleCaptions"
                                    data-bs-slide="next">
                                        ...
                                        <tr>
                                            <td class="w-30">
                                                <div
                                                    ...
                                                    <div>
                                                        <img src="@/assets/admin/img/icons/flags/US.png"
                                                            alt="Country flag">
                                                    </div>
                                                    <div class="ms-4">
                                                        <p
                                        ...
                                        <tr>
                                            <td class="w-30">
                                                <div
                                                    class="d-flex px-2 py-1 align-items-center">
                                                    <div>
                                                        <img src="@/assets/admin/img/icons/flags/DE.png"
                                                            alt="Country flag">
                                                    </div>
                                                    <div class="ms-4">
                                                        <p
                                        ...
                                        <tr>
                                            <td class="w-30">
                                                <div
                                                    class="d-flex px-2 py-1 align-items-center">
                                                    <div>
                                                        <img src="@/assets/admin/img/icons/flags/GB.png"
                                                            alt="Country flag">
                                                    </div>
                                                    <div class="ms-4">
                                                        <p
                                        ...
                                        <tr>
                                            <td class="w-30">
                                                <div
                                                    class="d-flex px-2 py-1 align-items-center">
                                                    <div>
                                                        <img src="@/assets/admin/img/icons/flags/BR.png"
                                                            alt="Country flag">
                                                    </div>
                                                    <div class="ms-4">
                                                        <p
                                ...
                                <ul class="list-group">
                                    ...
                                    <li
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div
                                                class="icon icon-shape icon-sm me-3 bg-gradient-dark shadow text-center">
                                                <i
                                                    class="ni ni-tag text-white opacity-10"></i>
                                            </div>
                                            <div class="d-flex flex-column">
                                                <h6 class="mb-1 text-dark text-sm">
                                                    Tickets</h6>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div
                                            class="icon icon-shape icon-sm me-3 bg-gradient-dark shadow text-center">
                                            <i
                                                class="ni ni-box-2 text-white opacity-10"></i>
                                        </div>
                                        <div class="d-flex flex-column">
                                            <h6 class="mb-1 text-dark text-sm">
                                                Error logs</h6>
                                ...
                                <li
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div
                                            class="icon icon-shape icon-sm me-3 bg-gradient-dark shadow text-center">
                                            <i
                                                class="ni ni-satisfied text-white opacity-10"></i>
                                        </div>
                                        <div class="d-flex flex-column">
                                            <h6 class="mb-1 text-dark text-sm">
                                                Happy users</h6>
                ...
                <a href="javascript:void(0)"
                    ...
                    <div class="badge-colors my-2 text-start">
                        <span class="badge filter bg-gradient-primary active"
                            data-color="primary"
                            @click="sidebarColorClick($event)"></span>
                ...
                <div class="mt-2 mb-5 d-flex">
                    ...
                    <div class="form-check form-switch ps-0 ms-auto my-auto">
                        <input class="form-check-input mt-1 ms-auto"
                            ...
                            @click="darkModeClick" ref="inputDarkMode">
                    </div>
                </div>
            </div>
        </div>
