<template>
    <div class="container detail-unique-post">
        <div class="grid grid-cols-4 gap-x-7 gap-y-5 mx-auto">
            <div class="main-detail-post col-span-4 row-span-1 lg:col-span-3 lg:row-span-3">
            ...
            <div class="main-related-posts col-span-4 p-3 box-popular_tags h-100 row-span-1 lg:col-span-1 lg:row-span-1">
