...
<template>
    ...
    <div id="content" role="main"
        class="flex flex-col h-screen bg-gray-100 realative">
        <!-- BUTTON BACK HOME  -->
        ...
        <div class="grid place-items-center mx-2 my-20 sm:my-auto">
            <div
                class="p-6 sm:p-10 bg-white rounded-xl shadow-lg dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="mt-4">
                    ...
                    ">
                        <div class="grid gap-y-4">
                            <div>
                                <label for="email"
                                    class="block text-sm font-bold ml-1 mb-2 dark:text-white">E-mail</label>
                                <div class="relative">
                                ...
                                <div
                                    v-if="(authStore.errors.email && authStore.errors.email[0] == 'The email field is required.')">
                                ...
                                <div class="p-2 mt-2 text-green-900 font-semibold bg-green-300 rounded-md"
