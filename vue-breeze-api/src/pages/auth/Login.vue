        ...
        <div class="grid place-items-center mx-2 my-20 sm:my-auto">
            <div class="w-11/12 p-12 sm:w-8/12 md:w-6/12 lg:w-5/12 2xl:w-4/12 
                ...
                <form class="mt-10" @submit.prevent="authStore.handleLogin(form)">
                    <!-- Email Input -->
                    <label for="email"
                        class="block text-xs font-semibold text-gray-600 uppercase">E-mail</label>
                    <input id="email" type="email" name="email" v-model="form.email"
                        placeholder="Địa chỉ e-mail" autocomplete="email"
                    ...
                    <!-- Password Input -->
                    <label for="password"
                        class="block mt-4 text-xs font-semibold text-gray-600 uppercase">Mật
                        khẩu</label>
                    ...
                    <div
                        ...
                        <router-link :to="{ name: 'Register' }" class="flex-2">
                            Tạo mới tài khoản?
                        </router-link>
                    </div>
                </form>
