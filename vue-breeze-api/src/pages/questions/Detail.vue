        ...
        <div class="grid grid-cols-4 gap-x-7 gap-y-5 mx-auto">
            <div
                ...
                <div class="flex justify-between">
                    ...
                    <div v-else-if="question.status_id == 3">
                        <span class="text-gray-500">
                            <span><i class='bx bx-block'></i></span>
                            Câu hỏi đã vi phạm khoảng 
                            {{ formatDateTimeFB(new Date(question.created_at)) }}
                        </span>
                    </div>
                    <div v-else>
                        <span class="text-gray-500">
                ...
                <div v-if="question.status_id == 1">
                    <h2 class="text-lg font-bold mb-3 mt-4">Bình luận ({{ question.comments_count }})</h2>
