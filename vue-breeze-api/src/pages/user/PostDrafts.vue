<template>
    <div class="container">
        <div
            class="grid grid-cols-4 gap-x-2 gap-y-5 mx-auto"
            aria-label="Sidebar"
        >
            <div
            ...
            >
                ...
                >
                    <li>
                        ...
                        >
                            <i
                                class="bx bxs-pencil flex-shrink-0 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white text-lg"
                            ></i>
                            <span
                            ...
                            <i
                                class="bx bx-chevron-down text-2xl"
                                sidebar-toggle-item
                            ></i>
                        </button>
                        <ul id="dropdown-example" class="py-2 space-y-2 ml-7">
                                ...
                                <button
                                    ...
                                    :class="{
                                        'bg-gray-100 text-blue-600':
                                            activeBtn == 1,
                                        'text-gray-900': activeBtn != 1,
                                    }"
                                >
                                    <i class="bx bxs-lock-alt text-md pr-3"></i>
                                    Bản nháp
                                    <span
                            ...
                            <li>
                                <button
                                    ...
                                    data-tabs-target="#block-post"
                                    type="button"
                                    role="tab"
                                    aria-controls="block-post"
                                    class="flex items-center w-full p-2 text-base font-normal transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 pl-11"
                                    :class="{
                                        'bg-gray-100 text-blue-600':
                                            activeBtn == 2,
                                        'text-gray-900': activeBtn != 2,
                                    }"
                                >
                                    <i class="bx bx-block text-md pr-3"></i>
                                    Vi phạm
                                </button>
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        >
                            <i
                                class="bx bx-question-mark flex-shrink-0 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white text-lg"
                            ></i>
                            <span
                                class="flex-1 ml-3 text-left whitespace-nowrap"
                                sidebar-toggle-item
                        ...
                        <ul id="dropdown-example2" class="py-2 space-y-2 ml-7">
                            <li>
                                <button
                                    id="draft-question-tab"
                                    @click="handleClickActiveBtn(3)"
                                    data-tabs-target="#draft-question"
                                    type="button"
                                    role="tab"
            ...
            >
                <!--! ***************************BÀI VIẾT******************************* -->
                <div
                    class="pt-2 rounded-lg dark:bg-gray-800 hidden"
                    id="post"
                    role="tabpanel"
                    aria-labelledby="draft-post-tab"
                >
                    <h2 class="text-gray-800 font-medium text-lg border-b pb-2">
                        Bản nháp
                    </h2>
                    <div v-if="draftPost && draftPost.length > 0" class="mt-3">
                        <div class="mb-2">
                            <form
                                @submit.prevent="
                                    searchDraftPost(dataSearch.post)
                                "
                            >
                                <label
                                    for="default-search"
                        ...
                        <div
                            class="py-2 border-b"
                            v-for="post in displayDraftPost"
                            :key="post.id"
                        >
                            <div class="flex items-center">
                                ...
                                >
                                    <i
                                        class="bx bxs-lock-alt text-emerald-500 text-lg"
                                    ></i>
                                    {{ post.title }}
                                </router-link>
                                <div class="ml-2">
                            ...
                            >
                                ...
                                <div class="relative">
                                    <button
                                        class="text-lg ml-1 flex items-center"
                                        @click="
                                            showDropDownDraft($event, post.id)
                                        "
                                    >
                                        <i class="bx bx-chevron-down"></i>
                                    </button>
                                    <ul
                                        :id="`drop-down-draft-${post.id}`"
                                    ...
                                    >
                                        ...
                                        <button
                                            @click="
                                                deleteDraftPost(post.id, post)
                                            "
                                            class="w-full text-left py-2 px-2 hover:bg-blue-100"
                                        >
                                            Xóa
                                        </button>
                                    </ul>
                        ...
                        <div
                            v-if="
                                draftPost &&
                                draftPost != null &&
                                draftPost.length > itemPerPagePost
                            "
                        >
                            <v-pagination
                                v-model="pagePost"
                                :pages="totalPagesPost"
                                :range-size="1"
                                active-color="#0074FF"
                                class="my-3 pl-0"
                    ...
                    <div v-else>
                        <h4
                            class="font-semibold text-center text-gray-500 mt-3"
                        >
                ...
                <div
                    ...
                    id="block-post"
                    role="tabpanel"
                    aria-labelledby="block-post-tab"
                >
                    <h2 class="text-gray-800 font-medium text-lg border-b pb-2">
                        Vi phạm
                    </h2>
                    <div v-if="draftPostBan && draftPostBan.length > 0" class="mt-3">
                        <!-- <div class="mb-2">
                            <form
                                @submit.prevent="
                                    searchDraftPostBan(dataSearch.post)
                                "
                            >
                                <label
                                    for="default-search"
                        ...
                        <div
                            class="py-2 border-b"
                            v-for="post in displayDraftPostBan"
                            :key="post.id"
                        >
                            <div class="flex items-center">
                                <router-link
                            ...
                            >
                                ...
                                <div class="relative">
                                    ...
                                    >
                                        ...
                                        <!-- <button
                                            @click="
                                                deleteDraftPostBan(post.id, post)
                                            "
                                            class="w-full text-left py-2 px-2 hover:bg-blue-100"
                                        >
                                            Xóa
                        ...
                        <div
                            v-if="
                                draftPostBan &&
                                draftPostBan != null &&
                                draftPostBan.length > itemPerPagePost
                            "
                        >
                            <v-pagination
                                v-model="pagePost"
                ...
                >
                    ...
                    <div
                        v-if="draftQuestion && draftQuestion.length > 0"
                        class="mt-3"
                    >
                        <div class="mb-2">
                            <form
                                @submit.prevent="
                                    searchDraftQuestion(dataSearch.question)
                                "
                            >
                                <label
                                    for="default-search"
                        ...
                        >
                            ...
                            >
                                ...
                                <div class="relative">
                                    ...
                                    <ul
                                        :id="`drop-down-draft-${question.id}`"
                                        class="bg-white shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded w-28 absolute hidden z-20 drop-down-container"
                                    >
                                        <router-link
                                            :to="{
                        ...
                        <div
                            v-if="
                                draftQuestion &&
                                draftQuestion != null &&
                                draftQuestion.length > itemPerPageQuestion
                            "
                        >
                            <v-pagination
                                v-model="pageQuestion"
                                :pages="totalPagesQuestion"
                                :range-size="1"
                                active-color="#0074FF"
                                class="my-3 pl-0"
...
export default {
    ...
    computed: {
        displayDraftPost() {
            if (this.draftPost && this.draftPost != null) {
                var startIndex =
                    (this.currentPagePost - 1) * this.itemPerPagePost;
        ...
        displayDraftPostBan() {
            if (this.draftPostBan && this.draftPostBan != null) {
                var startIndex =
                    (this.currentPagePost - 1) * this.itemPerPagePost;
                var endIndex = startIndex + this.itemPerPagePost;
                if (endIndex > this.draftPostBan.length) {
                    endIndex = this.draftPostBan.length;
                }
                return this.draftPostBan.slice(startIndex, endIndex);
            }
        },
        displayDraftQuestion() {
            if (this.draftQuestion && this.draftQuestion != null) {
                var startIndex =
                    (this.currentPageQuestion - 1) * this.itemPerPageQuestion;
        ...
        totalPagesQuestion() {
            if (this.draftQuestion && this.draftQuestion != null) {
                return Math.ceil(
                    this.draftQuestion.length / this.itemPerPageQuestion
                );
            }
        },
        totalPagesPost() {
    ...
    methods: {
        ...
        fetchData() {
            axios
                .get(`api/posts/draft/${this.authId}`)
                .then((res) => {
            ...
            axios
                .get(`api/posts/draft/${this.authId}/ban`)
                .then((res) => {
                    // console.log(res.data);
                    this.draftPostBan = res.data.data;
                })
                .catch((err) => {
                    console.log(err);
                });
            axios
                .get(`api/questions/draft/${this.authId}`)
                .then((res) => {
                    // console.log(res.data);
        ...
        deleteDraftPost(id, item) {
            axios
                .delete(`api/posts/${id}`)
                .then((res) => {
                    this.draftPost = this.draftPost.filter(
                        (post) => post.id !== id
                    );
        ...
        deleteDraftPostBan(id, item) {
            axios
                .delete(`api/posts/${id}`)
                .then((res) => {
                    this.draftPostBan = this.draftPostBan.filter(
                        (post) => post.id !== id
                    );
                    if (this.displayDraftPostBan.length <= 1) {
                        this.currentPagePost = this.totalPagesPost;
                        this.pagePost = this.totalPagesPost;
                    }
                })
        ...
        deleteDraftQuestion(id, item) {
            axios
                ...
                .then((res) => {
                    this.draftQuestion = this.draftQuestion.filter(
        ...
        searchDraftPost(data) {
            axios
                .get(`api/posts/search/draft/${this.authId}`, {
                    params: {
                        title: data.title,
                    },
                })
        ...
        searchDraftQuestion(data) {
            axios
                .get(`api/questions/search/draft/${this.authId}`, {
                    params: {
                        title: data.title,
                    },
                })
