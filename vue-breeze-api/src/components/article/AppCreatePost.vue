<template>
    <div class="create-post-unique">
        ...
        <div class="">
            <input v-model="payload.title" placeholder="Tiêu đề" type="text"
                id="base-input"
        ...
        <div class="mt-3">
            <ckeditor :editor="editor" v-model="payload.body" @input="checkCkeditor" @focus="onEditorFocus" :config="editorConfig"/>
        </div>
