<template>
    <div class="mb-2 border-b border-gray-300">
        <router-link :to="{ name: 'PostDetail', params: {id: data.id}}" class="text-gray-800 tile-question hover:text-blue-500">{{ data.title }}</router-link>
        <div class="engagements flex items-center text-xs py-1">
            <span class="engagements-text">10
